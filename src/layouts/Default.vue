        ...
        <footer class="bg-white border-b border-gray-200 text-black">
            ...
            >
                ...
                <ul class="flex items-center">
                    <li class="mr-8">
                        <a class="text-black hover:text-gray-400" href="https://cybercoder.io/ILKIN_MUSAYEV_CV.pdf" target="_blank">
                            <svg
                                fill="currentColor"
                            ...
                            >
                                <path
                                    d="m18.25 24h-12.5c-1.517 0-2.75-1.233-2.75-2.75v-18.5c0-1.517 1.233-2.75 2.75-2.75h12.5c1.517 0 2.75 1.233 2.75 2.75v18.5c0 1.517-1.233 2.75-2.75 2.75zm-12.5-22.5c-.689 0-1.25.561-1.25 1.25v18.5c0 .689.561 1.25 1.25 1.25h12.5c.689 0 1.25-.561 1.25-1.25v-18.5c0-.689-.561-1.25-1.25-1.25z"
                                />
                                <path
                                    d="m16.25 19.5h-8.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h8.5c.414 0 .75.336.75.75s-.336.75-.75.75z"
                                />
                                <path
                                    d="m16.25 14.5h-8.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h8.5c.414 0 .75.336.75.75s-.336.75-.75.75z"
                                />
                                <path
                                    d="m10.25 10h-1.5c-.965 0-1.75-.785-1.75-1.75v-2.5c0-.965.785-1.75 1.75-1.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75h-1.5c-.138 0-.25.112-.25.25v2.5c0 .138.112.25.25.25h1.5c.414 0 .75.336.75.75s-.336.75-.75.75z"
                                />
                                <path
                                    d="m14.277 9.451-1.25-4.5c-.111-.399.123-.812.521-.923.401-.11.813.123.924.522l.528 1.898.527-1.898c.11-.399.522-.632.924-.522.398.111.633.524.521.923l-1.25 4.5c-.201.73-1.243.73-1.445 0z"
                                />
                            </svg>
                        </a>
                    </li>
